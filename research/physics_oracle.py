...
def generate_ground_truth() -> dict:
    ...
    results["evaporative_cooling"] = {
        "principle": "When a liquid evaporates, it absorbs the latent heat "
                     ...
                     "This is the thermodynamic basis for sweating, wet-bulb "
                     "thermometers, evaporative coolers, and cooling towers.",
        "latent_heat_water_kJ_kg": 2260,
