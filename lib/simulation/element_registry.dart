...
final List<int> baseColors = List<int>.filled(maxElements, 0x00000000)
  ...
  // -- Transition Metals --
  ..[El.scandium] = 0xFFD0D0D8  // Silvery white
  ..[El.titanium] = 0xFF878681  // Distinctive titanium gray
  ..[El.vanadium] = 0xFF8890A0  // Steel blue-gray
  ..[El.chromium] = 0xFFDBDFE0  // Bright mirror chrome
  ..[El.manganese] = 0xFFA89898 // Pinkish-gray (oxidized tone)
  ..[El.cobalt] = 0xFF5868B8   // Rich cobalt blue
  ..[El.nickel] = 0xFFC8C0A8   // Warm yellow-silver
  ..[El.zinc] = 0xFFB8C0C8     // Cool blue-white
  ..[El.yttrium] = 0xFFCCD0D0  // Light silvery
  ..[El.zirconium] = 0xFFD0D8E0 // White-silver with blue
  ..[El.niobium] = 0xFF8898B0  // Blue-gray anodized look
  ..[El.molybdenum] = 0xFFA0A0A8 // Gray metallic
  ..[El.technetium] = 0xFFA8A8B8 // Silvery (radioactive shimmer)
  ..[El.ruthenium] = 0xFFB0A8A0 // Warm gray
  ..[El.rhodium] = 0xFFD8D8E0  // Bright reflective silver
  ..[El.palladium] = 0xFFE0DCD8 // Warm silver-white
  ..[El.silver] = 0xFFC8C8D0   // Classic cool silver
  ..[El.cadmium] = 0xFFD8D0C0  // Soft yellow-silver
  ..[El.hafnium] = 0xFFA8A8B0  // Gray with blue undertone
  ..[El.tantalum] = 0xFF9098A8  // Dark blue-gray
  ..[El.tungsten] = 0xFF707880  // Dark steel gray-blue
  ..[El.rhenium] = 0xFFB0A8A8  // Warm gray-silver
  ..[El.osmium] = 0xFF7880A0   // Deep blue-gray (densest metal)
  ..[El.iridium] = 0xFFD0D8E0  // White-silver (corrosion resistant)
  ..[El.platinum] = 0xFFE5E4E2  // Classic platinum
  ..[El.gold] = 0xFFFFD700     // Classic gold
  ..[El.mercury] = 0xFFD0D8E8  // Liquid silver with blue
  ..[El.rutherfordium] = 0xFF808890 // Synthetic dark gray
  ..[El.dubnium] = 0xFF889098   // Synthetic steel
  ..[El.seaborgium] = 0xFF7880A0 // Synthetic blue-gray
  ..[El.bohrium] = 0xFF909098   // Synthetic medium gray
  ...
  // -- Metalloids --
  ..[El.boron] = 0xFF4A3830    // Dark brown-black
  ..[El.silicon] = 0xFF6A6A78  // Dark gray (semiconductor)
  ..[El.germanium] = 0xFF909088 // Gray-white with warm tone
  ..[El.arsenic] = 0xFF686870  // Dark steely gray
  ..[El.antimony] = 0xFFB8B0B8 // Tin-white with pink tint
  ..[El.tellurium] = 0xFFA8B0C0 // Silver-white with blue tint
  // -- Nonmetals --
  ...
  ..[El.tennessine] = 0xFF484048 // Very dark, predicted halogen
  // -- Lanthanides --
  ..[El.lanthanum] = 0xFFD0D0D8   // Silvery white
  ..[El.cerium] = 0xFFD8C898      // Golden-silver (tarnishes yellow)
  ..[El.praseodymium] = 0xFFB8C8A0 // Silvery with green tint
  ..[El.neodymium] = 0xFFC0B0C8   // Silvery with violet tint
  ..[El.promethium] = 0xFF80D880   // Green luminescence (radioactive)
  ..[El.samarium] = 0xFFD0C8A0    // Pale yellowish silver
  ..[El.europium] = 0xFFD8D0B0    // Soft yellow-silver (phosphor)
  ..[El.gadolinium] = 0xFFD8D8E0  // Bright silvery white
  ..[El.terbium] = 0xFFC0C8A8    // Silver with slight green
  ..[El.dysprosium] = 0xFFCCC8B8  // Soft silver-yellow
  ..[El.holmium] = 0xFFD8D0A0    // Yellowish silver (magnetic)
  ..[El.erbium] = 0xFFD8B8C0     // Pink-silver tint
  ..[El.thulium] = 0xFFC8C8D8    // Gray-silver with blue
  ..[El.ytterbium] = 0xFFD0C8C8  // Warm silver
  ..[El.lutetium] = 0xFFE0E0E8   // Bright white-silver
  // -- Actinides --
  ..[El.actinium] = 0xFFC0D8E0   // Silvery-blue glow
  ..[El.thorium] = 0xFF909898    // Dark silvery
  ..[El.protactinium] = 0xFFB0B8C0 // Bright silvery with blue
  ..[El.neptunium] = 0xFF7888A0  // Silvery-blue
  ..[El.plutonium] = 0xFF606870  // Dark silvery
  ..[El.americium] = 0xFF90A090  // Silvery green tint
  ..[El.curium] = 0xFF90A880    // Pale olive-silver
  ..[El.berkelium] = 0xFFA8A078  // Amber-silver
  ..[El.californium] = 0xFF98B088 // Soft green-silver
  ..[El.einsteinium] = 0xFFB09880 // Warm bronze-silver
  ..[El.fermium] = 0xFF889098    // Cool steel-silver
  ..[El.mendelevium] = 0xFF9890A0 // Lavender-silver
  ..[El.nobelium] = 0xFFA0A8A0  // Neutral gray-silver
  ..[El.lawrencium] = 0xFFB0A8B0 // Mauve-silver
  // -- Superheavy (synthetic, predicted appearances) --
  ..[El.hassium] = 0xFF787888   // Steel blue-gray
  ..[El.meitnerium] = 0xFF808898 // Lighter steel-blue
  ..[El.darmstadtium] = 0xFFD0C890 // Predicted gold-like
  ..[El.roentgenium] = 0xFFDCD8D0 // Predicted silver-like
  ..[El.copernicium] = 0xFFD0D8E0 // Predicted liquid-silver (like mercury)
  ..[El.nihonium] = 0xFFA8A0B0  // Predicted gray-violet
  ..[El.flerovium] = 0xFFB8B8C8 // Predicted lead-like silver
  ..[El.moscovium] = 0xFF988898 // Predicted dusky rose-gray
  ..[El.livermorium] = 0xFFA0A0B0 // Predicted bluish-gray
  ..[El.oganesson] = 0x60B0B8C8 // Noble gas, predicted semi-transparent
  ..[El.vapor] = 0x40DCEEFF
  ..[El.cloud] = 0x90E6EEF8;
...
void _initPeriodicElements() {
  ...
  elementProperties[El.xenon] = const ElementProperties(
    density: 20, gravity: 1, state: PhysicsState.gas, // heavier than air, sinks slowly
    heatConductivity: 0.02, baseTemperature: 128,
