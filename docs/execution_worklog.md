...
- Moved local and cloud optimizer config writing onto the same manifest-backed contract in [`/home/nickalus/code/The-Particle-Engine/research/optimizer.py`](/home/nickalus/code/The-Particle-Engine/research/optimizer.py) and [`research/cloud/run_optimizer.py`](../research/cloud/run_optimizer.py).
...
- Added config normalization back from canonical payloads in [`/home/nickalus/code/The-Particle-Engine/research/parameter_contract.py`](/home/nickalus/code/The-Particle-Engine/research/parameter_contract.py) and moved [`research/cloud/benchmark_optuna.py`](../research/cloud/benchmark_optuna.py) (formerly `proper_benchmark.py`) onto that shared loader.
